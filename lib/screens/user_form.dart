...
import 'package:flutter_news/bottom_nav_pages/bottom_nav_controller.dart';
import 'package:flutter_news/widgets/customButton.dart';
import 'package:flutter_news/widgets/myTextField.dart';
...
class _UserFormState extends State<UserForm> {
  ...
  Future<void> _selectDateFromPicker(BuildContext context) async {
    ...
    if (picked != null)
      setState(() {
        _jobController.text = "${picked.day}/ ${picked.month}/ ${picked.year}";
      });
  }
